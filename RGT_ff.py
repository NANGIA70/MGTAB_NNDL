...
def main(seed):
    ...
    def test():
        ...
        f1 = f1_score(label[test_mask], output[test_mask], average='binary')
        precision = precision_score(label[test_mask], output[test_mask], average='binary')
        recall = recall_score(label[test_mask], output[test_mask], average='binary')
